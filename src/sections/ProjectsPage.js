      ...
      <Container>
        <section className="text-center my-5">
          ...
          <Row className="text-center">
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <View className="overlay rounded z-depth-1" waves>
                <img src="https://mdbootstrap.com/img/Photos/Others/project4.jpg" alt="sample" 
                className="img-fluid"/>
                <a>
                  <Mask overlay="white-slight"/>
                </a>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <View className="overlay rounded z-depth-1" waves>
                <img src="https://mdbootstrap.com/img/Photos/Others/images/88.jpg" alt="sample" className="img-fluid"/>
                <a>
                  <Mask overlay="white-slight"/>
                </a>
              </View>
